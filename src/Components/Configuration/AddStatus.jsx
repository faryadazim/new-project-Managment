...
function AddStatus({ togle }) {
  ...
  const addData = async () => {
    if (inpVal.status1 === "" || inpVal.status_colour === "") {
      setisFormValidate(false);
    } else {
      handleClose();

      const res = await fetch(
        "http://usman1206-001-site1.btempurl.com/api/Status",
        {
          method: "POST",
          headers: {
            Authorization:
      ...
      console.log(data);
      getData();
      setinpVal({ status1: "", status_colour: "" });
      notify();
    }
  };
  const getData = async () => {
  ...
  const deleteData = async (id) => {
    const dltres = await fetch(
      `http://usman1206-001-site1.btempurl.com/api/Status/${id}
`,
      {
        method: "DELETE",
        headers: {
  ...
  const updateData = async (id) => {
    if (inpVal.status1 === "" || inpVal.status_colour === "") {
      ...
      await fetch(`http://usman1206-001-site1.btempurl.com/api/Status/${id}`, {
        method: "PUT",
        headers: {
          Authorization:
            "Bearer 1DKy2hsnj8KKWTeVaFWYmh-WmAfKqNCrQ3jZoheLbU8ps_qk6ZRlMV0cpn-sIXxK_GdZuEbLQlE23KggzmDfEYhiFDz9U-3l9zlYUbY-AYJcesk5iXzOE8IJsdQNSCF1HPthA09GSC8vfZJAijwKe5y3VeiMlNB6Tvx7ZV4c2U3QwI9SgsZXqX0J8vIxv-adApqkv8TZAJma5AVPaGPVhjNxmv-PVFYnKYZBniA5H6VxXrVr0m3g0un3PQy4ZfDFDbfhKYbWxeP5v-JQY4b94vh4lwSLVAN81b6hRU2xEKLg6pPDXJVIRZP2e_0Wd9bWJbI4BQBzMU27qaCtHyOilsUaoX-VyloD33SW5fS9WD7o_893eo7-6TYtQEzMwhBHbi1w-zGMYZ8LBoe6ogWq5UmPZAbvll35eaa2lswjtL02n9TBdd92CeUcZqlJ_JgjdDWri84xpSOvWWkQ8W7JfTg3ivspKBaERRKulz9h34mAMIPOrUD7_xaaQ5RaWaqq",
        ...
        <> */}
            ...
            <Modal.Body>
              <div className="field item form-group">
                <label className="col-form-label col-md-4 col-sm-4  label-align">
                  Status Name <span className="imp">*</span>
                </label>
                <div className="col-md-8 col-sm-8">
                  <input
                    className={`form-control ${
                      !isFormValidate && inpVal.status1 === "" && "border_colr"
                    }`}
                    type="text"
                    placeholder=" Enter Status "
                    value={inpVal.status1}
                    onChange={(e) => {
                      setinpVal({
                        ...inpVal,
              ...
              <div className="field item form-group">
                <label className="col-form-label col-md-5 col-sm-4  label-align">
                  Status Color <span className="imp">*</span>
                </label>
                <div className="col-md-8 col-sm-8">
                  <input
                    className={`form-control ${
                      !isFormValidate &&
                      inpVal.status_colour === "" &&
                      "border_colr"
                    }`}
                    type="text"
                    placeholder=" Enter Color"
                    value={inpVal.status_colour}
                    onChange={(e) => {
                      setinpVal({
                        ...inpVal,
                        status_colour: e.target.value,
                      });
                    }}
                  />
                </div>
          ...
          <div id="main_content">
            <div
              ...
              style={{ display: togle === 5 ? "block" : "none" }}
            >
